...
<section id='form'>
    <div class="container col-9 mb-5 mt-5">
        <h1 class="panen text-center mb-4" style="color:#238E68; font-weight: bold">Modal Mas Tani</h1>
        ...
        <form action="/modal" method="post" enctype="multipart/form-data">
            @csrf
            <input type="hidden" class="form-control @error('paket') is-invalid @enderror" name="paket" value="Mas Tani">
